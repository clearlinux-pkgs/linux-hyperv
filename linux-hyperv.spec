...
Group:          kernel
Source0:        https://cdn.kernel.org/pub/linux/kernel/v5.x/linux-5.3.17.tar.xz
Source1:        config
Source2:        cmdline
...
Patch0051: 0051-x86-fpu-Don-t-cache-access-to-fpu_fpregs_owner_ctx.patch
#mainline.end
